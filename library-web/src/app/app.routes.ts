...
export const routes: Routes = [
  ...
  { path: 'stories/drafts/:draftId', loadComponent: () => import('./features/story-creation/story-creation-page/story-creation-page.component').then((m) => m.StoryCreationPageComponent) },
